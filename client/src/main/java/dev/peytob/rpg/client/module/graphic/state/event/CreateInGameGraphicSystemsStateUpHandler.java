...
@Component
public class CreateInGameGraphicSystemsStateUpHandler extends StateSetUpEventHandler<InGameEngineState> {

    private final SystemFactory systemFactory;

    public CreateInGameGraphicSystemsStateUpHandler(SystemFactory systemFactory) {
